...
public class Matrix3 {
	...
	public String toString() {
		...
		fmt.format("Matrix:\n", new Object[0]);
		fmt.format("  < %f %f %f >\n", new Object[] { Double.valueOf(this.xx),
				Double.valueOf(this.xy), Double.valueOf(this.xz) });
		fmt.format("  < %f %f %f >\n", new Object[] { Double.valueOf(this.yx),
				Double.valueOf(this.yy), Double.valueOf(this.yz) });
		fmt.format("  < %f %f %f >\n", new Object[] { Double.valueOf(this.zx),
				Double.valueOf(this.zy), Double.valueOf(this.zz) });
		return sb.toString();
	}
}
