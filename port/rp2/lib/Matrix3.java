...
public class Matrix3
{
  ...
  public static Matrix3 getRotY(double angle) {
    ...
    tr.xx = c; tr.xy = 0.0D; tr.xz = s;
    tr.yx = 0.0D; tr.yy = 1.0D; tr.yz = 0.0D;
    tr.zx = (-s); tr.zy = 0.0D; tr.zz = c;
    return tr;
  }

  public Vector3 getBasisVector(int n) {
    if (n == 0) return new Vector3(this.xx, this.xy, this.xz);
    if (n == 1) return new Vector3(this.yx, this.yy, this.yz);
